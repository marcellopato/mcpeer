...
<head>
    ...
    <title>{{ $title ?? 'MCPeer' }} - {{ config('app.name', 'MCPeer') }}</title>
...
<body class="font-sans antialiased h-full bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <h1 class="text-2xl font-bold mcpeer-gradient bg-clip-text text-transparent">
                                MCPeer
                            </h1>
                        </div>
            ...
            <a href="{{ route('servers.index') }}" 
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button onclick="toggleTheme()" 
                                class="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-lg">
